...
interface LeaveLeagueMemberDrawerProps {
  isOpen: boolean;
  onClose: () => void;
}

const LeaveLeagueMemberDrawer = ({
  isOpen,
  onClose,
}: LeaveLeagueMemberDrawerProps) => {
                ...
                <div className="flex flex-col items-center gap-6 px-6 pb-2 pt-2">
                  ...
                  <div className="text-center">
                    <h4 className="text-neutral-50 text-lg font-bold mb-1">
                      ¿Deseas salir de la liga <br />
                      "LOS ÚLTIMOS SIEMPRE"?
                    </h4>
                  </div>

                  <p className="font-body-normal-regular text-neutral-50 text-center">
                    Solo los administradores recibirán una notificación cuando
                    sales de una liga
                  </p>
...
export default LeaveLeagueMemberDrawer;
