...
export const UserLevelBadge = ({ level, currentXP, maxXP, showXP = true }: UserLevelBadgeProps) => {
  return (
    <div>
      <div className="w-[250px] h-[250px] rounded-full p-1 bg-linear-to-r from-primary-500 to-secondary-900 shadow-[0px_0px_31px_0px_#FF2D7473] mb-2">
        <div className="w-full h-full rounded-full bg-linear-to-r from-primary-500/10 to-secondary-500/10 flex items-center justify-center">
